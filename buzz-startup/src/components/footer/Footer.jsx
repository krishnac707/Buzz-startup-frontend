        ...
        <div className='footer-main-body'>
            ...
            <div className="footer-second-div">
                ...
                <div className='footer-third-div'>
                    <div>
                        <p className="mb-0 ccp" onClick={()=>router("/")}>Home</p>
                    ...
                    <div>
                        ...
                        <p className="mb-0 ccp" onClick={()=>router("/investor-page")}>Investors</p>
                        <p className="mb-0 ccp" onClick={()=>router("/about-us")}>About us</p>
                        <p className="mb-0 ccp" onClick={()=>router("/contact-us")}>Contact us</p>
                    </div>
                </div>
            </div>
            ...
            <div className="footer-fourth-div">
                ...
                <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16">
